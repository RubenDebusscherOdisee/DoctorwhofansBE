...
actions.my_profile.label = "Mijn profiel"
...
import_filters:csv:help = "Hiermee kan je in bulk data toevoegen met 1 regel per record.  Keys worden niet gevolgd, dus moet het id van het desbetreffende record genomen worden, lege velden vul je niet in maar je plaatst ze wel (om aan het aantal ingevoerde velden te raken, tekst wordt niet tussen aanhalingstekens geplaatst."
