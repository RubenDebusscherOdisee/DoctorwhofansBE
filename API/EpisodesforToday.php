...
header('Content-Type: application/json');
	...
	$antwoord['Seasons'] = "Geen resultaten gevonden.";
	...
	$stmt1 = $conn->prepare("SELECT * FROM episodes inner join serials on serial_id = serials.id where EXTRACT( MONTH FROM original_air_date)=EXTRACT( MONTH FROM curdate()) and EXTRACT( day FROM original_air_date)=EXTRACT( day FROM curdate())");
