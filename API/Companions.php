...
header('Content-Type: application/json');
	...
	$stmt1 = $conn->prepare("select companions.id,companions.name as Role,actors.name as PlayedBy,actors.gender from companions left join actors on companions.actor=actors.id");
