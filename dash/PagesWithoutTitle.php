<?php
	...
	$stmt1 = $conn->prepare("SELECT l.* FROM Topics l WHERE l.id NOT IN (SELECT  A_Pagina FROM alles r inner join L_Types on L_Types.LT_Id=r.A_Type where L_Types.LT_Naam like '%titel')");
