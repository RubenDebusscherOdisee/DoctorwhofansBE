...
<html lang="nl">
    ...
    <head>
        ...
        <title><?php $title = str_replace("_", " ", $menu);echo $title; if(isset($_GET['taal'])){echo" ";echo $_GET['taal'];}?></title>
        ...
        <meta name=description lang=en content="Doctor who is a phenomenon, worldwide. Time that Dutch-speaking fans now also get their own platform. Here you can find more info about <?php echo $title;?>." />
        ...
        <script async>
            ...
            $(document).ready(function(){
                ...
                if(menu==="Contact"){$("#txtEditor").Editor();}

                if (menu!=="Home"){getpad(menu);} 

                if(menu==="Home"){$('footer').prepend("<p class='quote'></p>");GetOneRandomQuote();}

                if(menu==="News"){GetNews();}      

                if(menu==="Companions"){$(".col-6").append('<div class="open-close"></div>');companionsophalen(taal,menu,id)}
        ...
        $(document).ready(function(){
            ...
            $('input[type=text]').on('keydown', function(e) { if (e.which == 13) { e.preventDefault();ZoekPagina(); } });

        })

            jQuery(document).ready(function(){var c=220, b=500;jQuery(window).scroll(function(){if(jQuery(this).scrollTop()>c){jQuery(".back-to-top").fadeIn(b);}else{jQuery(".back-to-top").fadeOut(b);}});

            jQuery(".back-to-top").click(function(e){e.preventDefault();jQuery("html, body").animate({scrollTop:0},b);return false;});
    ...
    <body class=init>
        ...
        <nav class=megamenu>
            ...
            <ol>
                ...
                <li class="standaard" style="width:10%">
                    ...
                    <span><a href="https://www.doctorwhofans.be/Home/" aria-label="Home"><img style="width:60px" src="../images/gallifreyan_black.png" alt="Logo of Doctorwhofans Belgium" /></a>
                        ...
                        <ol>
                            ...
                            <li class="accessible-megamenu-panel-group">
                                ...
                                <ol>
                                    ...
                                    <li style="padding-bottom: 2em;"><a href="../Sarah_Jane_Adventures/"><img src="../images/SJA.png" alt="Sarah Jane Adventures logo"/> Sarah Jane Adventures</a></li>
                            ...
                            <li class="accessible-megamenu-panel-group">
                                ...
                                <ol>
                                    ...
                                    <li style="padding-bottom: 1em;"><a href="../UNIT/"><img src="../images/UNIT.png" alt="UNIT logo" /> UN.I.T</a></li>
        ...
        <div id="overlay_Zoeken">
            ...
            <a href=# class="close_zoeken link"><img src="../images/overlay/981077-32.png" alt="Sluiten/Close" class=close_IMG/> Close</a>
